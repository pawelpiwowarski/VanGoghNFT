...
const ImageGalleryPage: React.FC<Props> = ({ images }) => {
  ...
  const [page, setPage] = useState(Number(localStorage.getItem('currentPage')) || 1); // get current page from localStorage or default to 1
      ...
      <div className="flex justify-center items-center py-4">
        {Array(Math.ceil(images.length / imagesPerPage))
          ...
          .map((_, i) => (
            ...
            onClick={() => { handlePageChange(i + 1); sessionStorage.setItem('currentPage', String(i + 1)); }
